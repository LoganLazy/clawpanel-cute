...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            extensions::browser_status,
            extensions::browser_start,
            extensions::browser_stop,
            extensions::browser_install,
            extensions::browser_screenshot,
            // Agent 管理
            agent::list_agents,
            agent::add_agent,
            agent::delete_agent,
