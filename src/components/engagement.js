...
export function tryShowEngagement() {
  ...
  const shareText = '推荐一个开源的 OpenClaw 管理面板 — ClawStar，一键搭建、便捷管理模型和 Agent，还内置 Girl Star 帮你排查问题，小白也能轻松上手 👉 https://github.com/LoganLazy/clawpanel-cute'
  ...
  overlay.innerHTML = `
    <div class="engage-modal">
      ...
      <div class="engage-header">
        ...
        <div class="engage-title">感谢你使用 ClawStar</div>
      </div>

      <div class="engage-message">
        ClawStar 是一个<strong>完全开源、免费</strong>的项目，由晴辰云团队专职维护、持续更新。如果它帮到了你，对我们最大的鼓励就是：
      </div>
