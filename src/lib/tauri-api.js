...
export const api = {
  ...
  installOpenclaw: (source = 'official', version = null) => invoke('install_openclaw', { source, version }),
  upgradeOpenclaw: (source = 'official', version = null) => invoke('upgrade_openclaw', { source, version }),
