import{a as S,t as b,l as A}from"./index-ZS5CnNlZ.js";function G(e){return e?typeof e=="string"?e:typeof e=="object"?e.$env?`$env:${e.$env}`:e.$ref?`$ref:${e.$ref}`:JSON.stringify(e):String(e):""}function M(e){return e&&typeof e=="object"&&("$env"in e||"$ref"in e)}async function O(){const e=document.createElement("div");e.className="page",e.innerHTML=`
