import{t as i,a as n}from"./index-BeJpi4vN.js";function l(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}const u=[{label:"npm 官方源（默认）",value:"https://registry.npmjs.org"},{label:"淘宝镜像（可选）",value:"https://registry.npmmirror.com"}];async function S(){const e=document.createElement("div");return e.className="page",e.innerHTML=`
  ...
  `,x(e),v(e),e}async function v(e){const t=[d(e),y(e)];t.push(m(e)),await Promise.all(t)}async function d(e){var a;const t=e.querySelector("#proxy-bar");if(t)try{const r=await n.readPanelConfig(),s=((a=r==null?void 0:r.networkProxy)==null?void 0:a.url)||"";t.innerHTML=`
    ...
    `}catch(s){t.innerHTML=`<div style="color:var(--error)">加载失败: ${l(String(s))}</div>`}}async function m(e){const t=e.querySelector("#registry-bar");try{let a=await n.getNpmRegistry();a||(a="https://registry.npmjs.org");const r=u.some(o=>o.value===a);t.innerHTML=`
      <div style="display:flex;align-items:center;gap:var(--space-sm);flex-wrap:wrap">
