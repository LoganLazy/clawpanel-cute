import{a as n,t as o}from"./index-CB-svjh-.js";const v=[{key:"gateway",label:"Gateway 日志"},{key:"gateway-err",label:"Gateway 错误"},{key:"guardian",label:"守护进程"},{key:"guardian-backup",label:"备份日志"},{key:"config-audit",label:"审计日志"}];let s=null;async function m(){const e=document.createElement("div");e.className="page",e.innerHTML=`
